...
trainloader = loaderize(np.load(args.dataroot+'train_X.pkl.npy'), np.load(args.dataroot+'train_y.pkl.npy'), args.balance, args.batchSize * args.bptt)
...
model = RNNModel(args.model, inputSize, args.nhidden, args.nlayers, args.dropout)
